  ...
  return (
    <>
      <h2 className='text-xl font-bold mb-2'>Contacts</h2>
        <Link to='#' className="rounded-md bg-gray-200 hover:bg-gray-300 transition hover:shadow-gray-400 hover:shadow-md p-4 mb-4 pr-14 flex gap-x-3 relative">
          <div className='w-[59px] h-[59px] flex-none overflow-hidden'>
            <img src='https://robohash.org/XKQ.png?set=set1&size=150x150' alt='Image name' />
          </div>
          <div className="grow">
            ...
            <span className='text-base font-bold hover:underline'>test@gmail.com</span>
          </div>
          <button
            type="button"
